...
const socialLinks = [
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/parcelpoint.ke',
    icon: (
  ...
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/parcelpoint.ke',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/company/parcelpointke',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: 'TikTok',
    href: 'https://www.tiktok.com/@parcelpointke',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: 'YouTube',
    href: 'https://www.youtube.com/@parcelpointke/',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
